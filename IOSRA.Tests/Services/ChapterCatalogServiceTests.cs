...
namespace IOSRA.Tests.Services
{
    public class ChapterCatalogServiceTests
    {
        ...
        public ChapterCatalogServiceTests()
        {
            ...
            _musicRepo = new Mock<IMoodMusicRepository>(MockBehavior.Strict);
            _subService = new Mock<ISubscriptionService>(MockBehavior.Strict);

            _svc = new ChapterCatalogService(
                _chapterRepo.Object,
                _storyRepo.Object,
