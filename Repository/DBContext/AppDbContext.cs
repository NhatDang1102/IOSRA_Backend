...
namespace Repository.DBContext
{
    public partial class AppDbContext : DbContext
    {
        ...
        public virtual DbSet<ContentMod> ContentMods { get; set; } = null!;
        public virtual DbSet<OperationMod> OperationMods { get; set; } = null!;
        public virtual DbSet<account> accounts { get; set; } = null!;
        public virtual DbSet<account_role> account_roles { get; set; } = null!;
        public virtual DbSet<admin> admins { get; set; } = null!;
        public virtual DbSet<author> authors { get; set; } = null!;
        public virtual DbSet<author_rank> author_ranks { get; set; } = null!;
        public virtual DbSet<author_revenue_transaction> author_revenue_transactions { get; set; } = null!;
        public virtual DbSet<chapter> chapters { get; set; } = null!;
        public virtual DbSet<chapter_comment> chapter_comments { get; set; } = null!;
        public virtual DbSet<chapter_comment_reaction> chapter_comment_reactions { get; set; } = null!;
        public virtual DbSet<chapter_localization> chapter_localizations { get; set; } = null!;
        public virtual DbSet<chapter_purchase_log> chapter_purchase_logs { get; set; } = null!;
        public virtual DbSet<chapter_mood> chapter_moods { get; set; } = null!;
        public virtual DbSet<chapter_mood_track> chapter_mood_tracks { get; set; } = null!;
        public virtual DbSet<chapter_voice> chapter_voices { get; set; } = null!;
        public virtual DbSet<content_approve> content_approves { get; set; } = null!;
        public virtual DbSet<dia_payment> dia_payments { get; set; } = null!;
        public virtual DbSet<dia_wallet> dia_wallets { get; set; } = null!;
        ...
        public virtual DbSet<op_request> op_requests { get; set; } = null!;
        ...
        public virtual DbSet<story_weekly_view> story_weekly_views { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<author_revenue_transaction>(entity =>
            {
                ...
                entity.HasOne(d => d.author).WithMany(p => p.author_revenue_transactions)
                    ...
                    .HasConstraintName("fk_art_author");

                entity.HasOne(d => d.purchase_log).WithMany(p => p.author_revenue_transactions)
                    .HasForeignKey(d => d.purchase_log_id)
                    .HasConstraintName("fk_art_purchase");

                entity.HasOne(d => d.request).WithMany(p => p.author_revenue_transactions)
                    .HasForeignKey(d => d.request_id)
                    .HasConstraintName("fk_art_request");
            });
            ...
            modelBuilder.Entity<chapter>(entity =>
            {
                ...
                entity.HasOne(d => d.mood).WithMany(p => p.chapters)
                    .HasForeignKey(d => d.mood_code)
                    .OnDelete(DeleteBehavior.SetNull)
                    .HasConstraintName("fk_chapter_mood");
            });
            ...
            modelBuilder.Entity<op_request>(entity =>
            {
                ...
                entity.HasOne(d => d.requester)
                    .WithMany(p => p.op_requests_as_requester)
            ...
            modelBuilder.Entity<story>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.title, e.desc }, "ft_story_title_desc")
            ...
            modelBuilder.Entity<chapter_mood>(entity =>
            {
                entity.HasKey(e => e.mood_code).HasName("PRIMARY");
                entity.Property(e => e.mood_code).ValueGeneratedNever();
                entity.Property(e => e.created_at).HasDefaultValueSql("CURRENT_TIMESTAMP");
                entity.Property(e => e.updated_at)
                    .ValueGeneratedOnAddOrUpdate()
                    .HasDefaultValueSql("CURRENT_TIMESTAMP");
            ...
            modelBuilder.Entity<chapter_mood_track>(entity =>
            {
                entity.HasKey(e => e.track_id).HasName("PRIMARY");
                ...
                entity.HasOne(d => d.mood_codeNavigation).WithMany(p => p.chapter_mood_tracks)
                    .HasForeignKey(d => d.mood_code)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("fk_mood_track_mood");
            });

            // ----------------- VOICE PRICING / PURCHASE CONFIG -----------------
