...
namespace Repository.Interfaces
{
    public interface ISubscriptionRepository
    {
        ...
        Task<subscription?> GetLatestActiveAsync(Guid accountId, DateTime now, CancellationToken ct = default);
        Task<subscription?> GetByPlanAsync(Guid accountId, string planCode, CancellationToken ct = default);
