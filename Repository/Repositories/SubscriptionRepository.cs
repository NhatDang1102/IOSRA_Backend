...
namespace Repository.Repositories
{
    public class SubscriptionRepository : ISubscriptionRepository
    {
        ...
        public Task<subcription?> GetLatestActiveAsync(Guid accountId, DateTime now, CancellationToken ct = default)
            => _db.subcription
        ...
        public Task<subcription?> GetByPlanAsync(Guid accountId, string planCode, CancellationToken ct = default)
            => _db.subcription.FirstOrDefaultAsync(s => s.user_id == accountId && s.plan_code == planCode, ct);
        ...
        public Task AddSubscriptionAsync(subcription subscription, CancellationToken ct = default)
            => _db.subcription.AddAsync(subscription, ct).AsTask();
