...
namespace Service.Interfaces
{
    ...
    {
        Task<PagedResult<ChapterCommentResponse>> GetByChapterAsync(Guid chapterId, int page, int pageSize, CancellationToken ct = default);
        Task<StoryCommentFeedResponse> GetByStoryAsync(Guid storyId, Guid? chapterId, int page, int pageSize, CancellationToken ct = default);
