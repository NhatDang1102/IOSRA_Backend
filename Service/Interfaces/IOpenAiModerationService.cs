...
namespace Service.Interfaces
{
    ...
    {
        Task<OpenAiModerationResult> ModerateStoryAsync(string title, string? description, string outline, string languageCode, CancellationToken ct = default);
        Task<OpenAiModerationResult> ModerateChapterAsync(string title, string content, string languageCode, CancellationToken ct = default);
