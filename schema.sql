...
CREATE TABLE author (
  ...
  revenue_pending   BIGINT NOT NULL DEFAULT 0,
  revenue_withdrawn BIGINT NOT NULL DEFAULT 0,
  PRIMARY KEY (account_id),
...
CREATE TABLE dia_wallet (
  ...
  account_id  CHAR(36) NOT NULL,
  balance_dias BIGINT NOT NULL DEFAULT 0,
  locked_dias  BIGINT NOT NULL DEFAULT 0,
  updated_at   DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE wallet_payment (
  ...
  dias_delta BIGINT NOT NULL,
  dias_after BIGINT NOT NULL,
  ref_id     CHAR(36) NULL,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (trs_id),
